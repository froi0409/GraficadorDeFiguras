      ...
      switch (CUP$parser$act_num)
		...
		RESULT = start_val;
          ...
          case 5: // graficacionInstruccion ::= GRAFICAR graficacion 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("graficacionInstruccion",8, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		 ...
		 graficaciones.add(new Circulo(v[0], v[1], v[2], colorF)); System.out.println("CIRCULO\n"); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("graficacion",2, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 19: // animacion ::= ANIMAR OBJETO ANTERIOR reglaAnimacion 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("animacion",3, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 20: // animacion ::= 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("animacion",3, ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Double v1 = (Double)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int v2left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int v2right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		Double v2 = (Double)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int animationleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int animationright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String animation = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("reglaAnimacion",4, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 23: // tipoAnimacion ::= LINEA 
            {
              String RESULT =null;
		 RESULT="linea"; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("tipoAnimacion",10, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Double valo1 = (Double)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT=valo1*-1; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("valor",9, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Double valo2 = (Double)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT=valo1+valo2; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("valor",9, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String valo1 = (String)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT= new Double(valo1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("valor",9, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
